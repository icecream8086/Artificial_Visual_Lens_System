    ...
    <el-container>
      <el-header>
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
          ...
          <el-menu-item><el-icon>
              <User />
            </el-icon> 联系人</el-menu-item>
          <el-sub-menu index="3">
            <template #title><el-icon>
                <SetUp />
              </el-icon> Workspace</template>
      ...
      <el-container>
        <el-aside><el-menu default-active="2" class="el-menu-vertical-demo" :collapse="isCollapse" @open="handleOpen"
            @close="handleClose">
            <el-sub-menu index="1">
              <template #title>
                <el-icon>
