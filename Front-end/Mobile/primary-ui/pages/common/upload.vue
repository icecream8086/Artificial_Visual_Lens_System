<template>
	<view class="login_bg_containe">
		...
		<view style="height: 60rpx;"></view> -->
			<navigator class="buttons" url="../camera/idphoto/idphoto"><button type="primary">打开相机</button>
			</navigator>
			<view style="height: 60rpx;"></view>
			<navigator class="buttons" url="../camera/watermark/watermark"><button type="primary">打开定制水印相机</button>
			</navigator>
			<view style="height: 80rpx;"></view>
